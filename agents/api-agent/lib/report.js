/**
 * Terminal & JSON Report Formatter for API Agent
 */
class ApiReport {
  static printFindings(findings, options = {}) {
    ...
    console.log('\n========================================');
    console.log('   🔌 API Agent Static Code Analysis    ');
    console.log('========================================\n');

    if (findings.length === 0) {
      console.log('✅ 0 issues found. API layer is fully compliant with standards!\n');
      return;
    }
